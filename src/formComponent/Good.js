                    ...
                    <form onSubmit={this.changeSubmit} >
                        <div className='row bg-light '>
                            <div className='col-lg-3 border py-3'>
                                <i className="text-info fa fa-check-circle-o" aria-hidden="true"></i>
                ...
                <div className='container mt-3'>
                    ...
                    <form >
                        ...
                        <div className='text-right'>
                            <button type='reset' className='btn btn-info mr-2'> <span className="spinner-border spinner-border-sm"></span> reset</button>
                            <button type='submit' className='btn btn-outline-success'>submit</button>
                        </div>
                        <button className='btn btn-success  form-control mt-4' onClick={this.changeClear}>Clear</button>
